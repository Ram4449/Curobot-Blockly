...
// set motor block code changed by Ram Yadav
...
// block code changed by Ram Yadav

Blockly.Arduino.pwmMotorA = function() {
...
Blockly.Arduino.pwmMotorB = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	//var dropdown_stat = this.getFieldValue('STAT');
	var value_num = Blockly.Arduino.valueToCode(this, 'NUM', Blockly.Arduino.ORDER_ATOMIC);
	Blockly.Arduino.setups_['setup_output'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
...
Blockly.Arduino.dirMotorA = function() {
...
Blockly.Arduino.dirMotorB = function() {
	var value_pin = this.getFieldValue('PIN');
	var dropdown_stat = this.getFieldValue('STATE');
	Blockly.Arduino.setups_['setup_output_' + value_pin] = 'pinMode(' + value_pin + ', OUTPUT);';
	var code = 'digitalWrite(' + value_pin + ', ' + dropdown_stat + ');\n'
